            ...
            case "Customer name":
                {
                    ...
                    searchText && dispatch(fetchVehicles(searchText));
                    setSearchText("")
                    break;
                }
    ...
    return (
        <div className={classes.root}>
            <AppBar position="static" style={{ backgroundColor: 'ghostwhite ', color: 'black' }}>
                <Toolbar>
                    <Typography style={{ margin: "10px" }}><Link to="/viewVehicle" style={{ color: 'black' }}>Manage Vehicles</Link></Typography>
                    <Typography style={{ margin: "10px" }}><Link to="/viewVehicle" style={{ textDecoration: 'none', color: 'black' }}>View Vehicle</Link></Typography>
